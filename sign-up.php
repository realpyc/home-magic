    ...
    <header id="header" class="ex-2-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Sign Up</h1>
                    <p>Fill out the form below to sign up for HOMEMAGIC. Already signed up? Then just <a class="white" href="login.php">Log In</a></p>
                    <div class="form-container">
                        <form action="sign-up.php" method="post">
                            ...
                            <div class="form-group">
                                <button type="submit" name="reg_user" class="form-control-submit-button">SIGN UP</button>
                            </div>
